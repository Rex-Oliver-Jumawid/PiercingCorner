...
export const dashField = "flex flex-col gap-[7px] text-xs font-[750] text-[#694d43] [&_input]:min-h-[42px] [&_input]:w-full [&_input]:rounded-[10px_7px_11px_8px] [&_input]:border-[1.5px] [&_input]:border-hippy-ink [&_input]:bg-[#fffaf0] [&_input]:px-3 [&_input]:py-2 [&_input]:text-hippy-ink [&_input]:shadow-[2px_2px_0_#d9a47e] [&_input]:outline-none [&_input]:placeholder:text-studio-muted [&_input:focus]:border-hippy-orange [&_input:focus]:outline-[3px] [&_input:focus]:outline-[#df682c35] [&_textarea]:min-h-[84px] [&_textarea]:w-full [&_textarea]:resize-y [&_textarea]:rounded-[10px_7px_11px_8px] [&_textarea]:border-[1.5px] [&_textarea]:border-hippy-ink [&_textarea]:bg-[#fffaf0] [&_textarea]:px-3 [&_textarea]:py-2 [&_textarea]:text-hippy-ink [&_textarea]:shadow-[2px_2px_0_#d9a47e] [&_textarea]:outline-none [&_textarea:focus]:border-hippy-orange [&_textarea:focus]:outline-[3px] [&_textarea:focus]:outline-[#df682c35]";
